...
const EventShowcase = () => {
	return (
		<div className="m-5 border rounded-3xl font-bold snap-x mx-auto snap-mandatory h-[250px] md:h-[400px] lg:h-[575px] flex w-screen md:w-[650px] lg:w-[1000px] overflow-scroll relative">
